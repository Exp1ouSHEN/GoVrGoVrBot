...
async def booking_form(m: types.Message):
    ...
    # Не принимаем кнопки главного меню как данные
    if m.text in {
        "🎮 Забронювати",
        "💰 Прайс",
        "📞 Адміністратор"
    ...
    if step == "comment":
        ...
        # ====================================================
        # ВАЖНО:
        # СРАЗУ блокируем повторную обработку сообщения
        # ====================================================
        ...
        requested_end = requested_start + hours_value
